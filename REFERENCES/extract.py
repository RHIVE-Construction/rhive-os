...
try:
    ...
    sheets_to_extract = ['Warranty', 'website mock', 'OLD preso quote', 'gen roof guide']
    out = ""
    for s in xls.sheet_names:
        if s in sheets_to_extract or True: # Actually let's just dump ALL sheets again securely
            try:
                out += f"\n\n--- {s} ---\n"
