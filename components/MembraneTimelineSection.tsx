...
const MembraneTimelineSection = () => {
    const steps = [
        ...
        {
            num: "02",
            icon: <Briefcase className="w-6 h-6" color="url(#blue-white-grad)" />,
        ...
        {
            num: "03",
            icon: <Building2 className="w-6 h-6" color="url(#blue-white-grad)" />,
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="text-center mb-20">
                    ...
                    <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter text-white mb-6">
                        COMMERCIAL <span className="bg-gradient-to-t from-rhive-blue to-white bg-clip-text text-transparent">ORCHESTRATION</span> PROTOCOL
                    </h2>
