                ...
                <div className="relative group perspective-[1000px]">
                    ...
                    <div className="relative z-10 w-full h-full min-h-[400px] bg-black border border-white/10 flex flex-col items-center justify-center p-8 overflow-hidden"
                        ...
                        <div className="relative z-20 flex flex-col items-center text-center space-y-6">
                            ...
                            <button 
                                onClick={() => setActivePageId('P-Scope')}
                                className="px-6 py-2 bg-[var(--rhive-pink)]/10 border border-[var(--rhive-pink)]/50 text-[var(--rhive-pink)] font-black text-base uppercase tracking-widest hover:bg-[var(--rhive-pink)] hover:text-white transition-all"
                            >
                                PLAY PROCESS VIDEO
                            </button>
                        </div>
