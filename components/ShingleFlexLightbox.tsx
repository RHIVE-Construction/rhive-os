...
const ShingleFlexLightbox: React.FC<ShingleFlexLightboxProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 py-8">
            ...
            >
                {/* Header */}
                <div className="p-8 border-b border-[var(--rhive-blue)]/20 flex justify-between items-center bg-[#0a0a0a] sticky top-0 z-20">
                    <div className="flex items-center gap-6">
                        <div className="p-4 bg-rhive-blue text-white shadow-[0_0_20px_rgba(8,19,124,0.4)]"
                    ...
                    <button
                        onClick={onClose}
                        className="w-12 h-12 border border-white/10 rounded-full flex items-center justify-center text-gray-500 hover:text-white hover:border-rhive-blue hover:bg-rhive-blue/10 transition-all"
                    >
                        <X className="w-6 h-6" />
                    </button>
                </div>
                ...
                {/* Content */}
                <div className="p-10 bg-[radial-gradient(circle_at_top_right,_rgba(8,19,124,0.05),_transparent_70%)] text-left">
                    <p className="text-gray-300 font-serif text-lg leading-relaxed mb-12 italic border-l-2 border-rhive-blue pl-6 text-left">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                        <div className="p-6 border border-white/10 bg-white/5 transition-all hover:border-rhive-blue/40">
                            <div className="flex items-center gap-3 mb-4">
                                <AlertOctagon className="w-5 h-5" color="url(#blue-white-grad)" />
                        ...
                        <div className="p-6 border border-white/10 bg-white/5 transition-all hover:border-rhive-blue/40">
                            <div className="flex items-center gap-3 mb-4">
                                <TrendingDown className="w-5 h-5" color="url(#blue-white-grad)" />
                        ...
                        <div className="p-6 border border-white/10 bg-white/5 transition-all hover:border-rhive-blue/40">
                            <div className="flex items-center gap-3 mb-4">
                                <Activity className="w-5 h-5" color="url(#blue-white-grad)" />
                    ...
                    <div className="space-y-6">
                        <div className="bg-black/40 border border-white/5 p-8">
                            <div className="text-base font-black uppercase tracking-[0.3em] mb-4 text-left bg-gradient-to-t from-rhive-blue to-white bg-clip-text text-transparent">Upgraded Components</div>
                            <div className="space-y-8">
                                <div>
                                    <h5 className="text-white font-bold text-base uppercase mb-2 flex items-center gap-2 text-left">
                                        <span className="w-1.5 h-1.5 bg-rhive-blue rounded-full"></span> FIELD SHINGLES
                                    </h5>
                                ...
                                <div className="border-t border-white/5 pt-6">
                                    <h5 className="text-white font-bold text-base uppercase mb-2 flex items-center gap-2 text-left">
                                        <span className="w-1.5 h-1.5 bg-rhive-blue rounded-full"></span> HIP & RIDGE SHINGLES
                                    </h5>
                                    <p className="text-gray-400 text-base font-serif leading-relaxed ml-3.5 italic text-left">
                    ...
                    <div className="mt-12 flex flex-col md:flex-row justify-between items-center gap-8 border-t border-white/10 pt-8 mt-16">
                        ...
                        <button
                            onClick={onClose}
                            className="px-12 py-4 bg-gradient-to-b from-white to-rhive-blue hover:from-white hover:to-[#08137C] text-black font-black uppercase tracking-widest text-base hover:scale-105 transition-all shadow-[0_0_20px_rgba(8,19,124,0.4)]"
                            style={{ clipPath: 'polygon(12px 0, 100% 0, 100% calc(100% - 12px), calc(100% - 12px) 100%, 0 100%, 0 12px)' }}
                        >
                            Select FLEX Upgrade
                        </button>
