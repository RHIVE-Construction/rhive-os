...
const ProcessTimelineSection = () => {
    const steps = [
        {
            num: "01",
            icon: <Satellite className="w-6 h-6" color="url(#blue-white-grad)" />,
        ...
        {
            num: "02",
            icon: <Calculator className="w-6 h-6" color="url(#blue-white-grad)" />,
        ...
        {
            num: "03",
            icon: <HardHat className="w-6 h-6" color="url(#blue-white-grad)" />,
        ...
        {
            num: "04",
            icon: <ShieldCheck className="w-6 h-6" color="url(#blue-white-grad)" />,
    ...
    return (
        <section className="py-24 bg-black border-y border-white/5 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-1/4 w-[40vw] h-[40vw] bg-rhive-blue/5 blur-[120px] rounded-full pointer-events-none"></div>
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="text-center mb-20">
                    ...
                    <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter text-white mb-6">
                        THE <span className="bg-gradient-to-t from-rhive-blue to-white bg-clip-text text-transparent">RHIVE WAY</span> PROTOCOL
                    </h2>
                ...
                <div className="relative">
                    ...
                    <div className="hidden lg:block absolute top-[60px] left-[10%] right-[10%] h-[2px] bg-white/5 z-0">
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-rhive-blue/50 to-transparent shadow-[0_0_15px_rgba(8,19,124,0.5)]"></div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {steps.map((step, idx) => (
                            <div key={idx} className="relative z-10 group flex flex-col items-center text-center">
                                {/* Number Marker */}
                                <div className="bg-gradient-to-t from-rhive-blue to-white bg-clip-text text-transparent opacity-30 font-black text-6xl md:text-8xl tracking-tighter mix-blend-screen -mb-10 group-hover:opacity-80 transition-all duration-500 pointer-events-none drop-shadow-[0_0_15px_rgba(59,130,246,0.5)] group-hover:drop-shadow-[0_0_25px_rgba(255,255,255,0.7)]">
                                    {step.num}
                                </div>
                                
                                {/* Hexagon Tech Node */}
                                <div className="w-16 h-16 bg-black border border-rhive-blue/30 mb-8 flex items-center justify-center relative shadow-[0_0_20px_rgba(8,19,124,0.1)] group-hover:shadow-[0_0_30px_rgba(8,19,124,0.4)] group-hover:bg-rhive-blue/10 transition-all duration-500"
                                     style={{ clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)' }}>
                                    <div className="group-hover:scale-110 transition-transform duration-500">
                                        {step.icon}
                                    </div>
                                    <div className="absolute inset-0 border-[2px] border-rhive-blue/0 group-hover:border-rhive-blue/50 blur-[2px] transition-all duration-500" style={{ clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)' }}></div>
                                </div>

                                <div className="bg-[#050505] border border-white/5 p-8 transition-colors duration-500 group-hover:border-rhive-blue/30 h-full w-full relative"
                                     style={{ clipPath: 'polygon(16px 0, 100% 0, 100% calc(100% - 16px), calc(100% - 16px) 100%, 0 100%, 0 16px)' }}>
                                    <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-rhive-blue/5 to-transparent pointer-events-none"></div>
