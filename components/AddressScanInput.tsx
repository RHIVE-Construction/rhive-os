            ...
            <div id={id} className="relative flex w-full max-w-2xl mx-auto h-16 group mt-8 scroll-mt-40 isolate">
                ...
                <div className="relative flex-grow flex items-center px-6 md:px-8 z-20">
                    ...
                    <input
                        ...
                        className="bg-transparent text-white w-full h-full outline-none placeholder-rhive-pink/60 font-black uppercase text-base tracking-[0.2em] text-left"
                        onChange={() => {
                ...
                <button
                    ...
                    className="relative h-full px-8 md:px-12 flex items-center justify-center gap-2 bg-rhive-pink text-white font-black uppercase text-base tracking-widest overflow-hidden group/btn hover:scale-[1.02] active:scale-95 transition-all duration-300 shadow-[0_0_20px_rgba(236,2,139,0.4)] shrink-0 z-20"
                    style={{
