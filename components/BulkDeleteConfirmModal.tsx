...
const BulkDeleteConfirmModal: React.FC<BulkDeleteConfirmModalProps> = ({ count, onClose, onConfirm }) => {
    ...
    return (
        <div
            id="bulk-delete-confirm-modal-backdrop"
        ...
        >
            ...
            {/* Panel */}
            <div
                id="bulk-delete-confirm-modal-panel"
            ...
            >
                ...
                <div className="flex items-start justify-between p-6 border-b border-gray-800">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h2 className="text-lg font-black text-white">Move to Trash</h2>
                        </div>
                    </div>
                    <button
                        id="bulk-delete-confirm-close-btn"
                        onClick={onClose}
                ...
                <div className="p-6 space-y-4">
                    {/* Count highlight */}
                    <div
                        className="flex items-center gap-4 p-4 bg-red-900/10 border border-red-900/30"
                        style={{ clipPath: 'polygon(8px 0, 100% 0, 100% calc(100% - 8px), calc(100% - 8px) 100%, 0 100%, 0 8px)' }}
                    >
                        <div className="text-3xl font-black text-red-400 shrink-0">{count}</div>
                        <div>
                            <p className="text-white font-bold text-sm">
                                {count === 1 ? 'record selected' : 'records selected'}
                            </p>
                            <p className="text-[11px] text-gray-500 mt-0.5 leading-relaxed">
                                {count === 1 ? 'This record' : 'All selected records'} will be moved to the Trash Bin and hidden from the pipeline.
                            </p>
                        </div>
                    </div>
                    ...
                    <div>
                        <label
                            htmlFor="bulk-deletion-reason-input"
                        ...
                        <input
                            id="bulk-deletion-reason-input"
                            type="text"
                            value={reason}
                            onChange={(e) => setReason(e.target.value)}
                            placeholder="e.g. Duplicates, customer withdrew..."
                            maxLength={200}
                    ...
                    <div className="flex items-start gap-3 p-3 bg-gray-900/40 border border-gray-800/50 rounded-sm">
                        ...
                        <p className="text-[11px] text-gray-500 leading-relaxed">
                            Records can be restored from the <span className="text-white">Trash Bin</span> at any time.
                            They are <span className="text-white">permanently deleted</span> after 90 days.
                        </p>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-end gap-3 px-6 pb-6">
                    <button
                        id="bulk-delete-confirm-cancel-btn"
                        onClick={onClose}
                        disabled={loading}
                    ...
                    <button
                        id="bulk-delete-confirm-submit-btn"
