        ...
        <div className="min-h-screen bg-[var(--bg-main)] text-[var(--text-main)] overflow-x-hidden pt-24 pb-20">
            <div className="max-w-5xl mx-auto px-6 lg:px-8">
                ...
                <div className="border-b border-white/10 pb-10 mb-12">
                    <div className="inline-flex items-center px-3 py-1 mb-6 rounded-sm bg-[#00D1FF]/10 border border-[#00D1FF]/20 font-mono text-base uppercase tracking-wider text-[#00D1FF]">
                ...
                <div className="bg-gradient-to-br from-[#00D1FF]/10 to-transparent p-10 border border-[#00D1FF]/20 text-center">
                    <h3 className="text-2xl leading-tight font-black text-white uppercase mb-4">Maximum Impact Defense</h3>
                    <p className="text-gray-400 text-base md:text-lg leading-relaxed max-w-prose mx-auto mb-8">Lock down extreme weather protection. Get an instant estimate for the O.C. FLEX package.</p>
                    <button
