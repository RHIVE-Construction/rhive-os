...
// ΓöÇΓöÇΓöÇ Floating label input with 8px Chamfer border ΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ Quick Bypass Panel with 6px Chamfer border ΓöÇΓöÇΓöÇ
            ...
            <div className="w-full max-w-xl flex flex-col items-center">
                ...
                >
                    ...
                    <div className="relative z-20">
                        ...
                        {/* ΓöÇΓöÇ CREDENTIALS FORM ΓöÇΓöÇ */}
                        ...
                        <div className="mt-10 text-center relative z-20">
                            <p className="text-[9px] text-gray-600 font-bold uppercase tracking-[0.5em] opacity-50">
                                Restricted Access ΓÇó RHIVE Industries ┬⌐ 2025
                            </p>
                        </div>
                    </div>
                </div>
