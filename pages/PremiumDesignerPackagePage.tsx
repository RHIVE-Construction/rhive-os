        ...
        <div className="min-h-screen bg-[var(--bg-main)] text-[var(--text-main)] overflow-x-hidden pt-24 pb-20">
            <div className="max-w-5xl mx-auto px-6 lg:px-8">
                ...
                <div className="border-b border-white/10 pb-10 mb-12">
                    <div className="inline-flex items-center px-3 py-1 mb-6 rounded-sm bg-[#00D1FF]/10 border border-[#00D1FF]/30 font-mono text-base uppercase tracking-wider text-[#00D1FF]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
                    {inclusions.map((item, i) => (
                        <div key={i} className={`bg-black/50 border p-6 rounded-sm transition-colors ${i === 1 ? 'border-[#00D1FF]/40 hover:border-[#00D1FF]' : 'border-white/5 hover:border-white/20'}`}>
                            {i === 1 && (
                                <div className="text-base font-mono text-[#00D1FF] uppercase mb-3 tracking-widest bg-[#00D1FF]/10 inline-block px-2 py-0.5">
                ...
                <div className="bg-gradient-to-br from-[#00D1FF]/10 to-transparent p-10 border border-[#00D1FF]/20 text-center">
                    <h3 className="text-2xl leading-tight font-black text-white uppercase mb-4">The Pinnacle of Defense</h3>
                    <p className="text-gray-400 text-base md:text-lg leading-relaxed max-w-prose mx-auto mb-8">Get an instant estimate for the GAF Premium Designer package using our pricing engine.</p>
                    <button
                        onClick={() => setActivePageId('P-12')}
                        className="px-8 py-4 bg-[#00D1FF] hover:bg-[#00b8e6] text-black font-black uppercase tracking-widest text-base transition-colors"
                    >
                        Request A Quote
                    </button>
                </div>
