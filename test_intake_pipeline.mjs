...
const screenshotsDir = 'C:\\Users\\mjrob\\.gemini\\antigravity\\brain\\8fdcba3d-1f0b-4d3d-8d77-842673c97208\\test-proofs';
...
async function runTests() {
    ...
    try {
        ...
        await page.click('text=Universal Intake Search');
        ...
        for (let i = 0; i < 13; i++) {
            ...
            const yOffset = 350;
            await page.click('#intake-google-map', { position: { x: xOffset, y: yOffset } });
        ...
        for (let i = 0; i < 11; i++) {
            const xOffset = 100 + (i * 40);
            const yOffset = 350;
            await page.click('#manage-google-map', { position: { x: xOffset, y: yOffset } });
            await page.waitForTimeout(250);
        }
...
`;
    ...
    fs.writeFileSync('C:\\Users\\mjrob\\.gemini\\antigravity\\brain\\8fdcba3d-1f0b-4d3d-8d77-842673c97208\\walkthrough.md', mdReport);
